    ...
    <div className="min-h-screen">
      ...
      <section className="pt-16 sm:pt-24 pb-12 sm:pb-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-[#e9edf1] via-[#f1f5f9] to-[#ffffff] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto flex flex-col items-center text-center relative z-10">
          ...
          {/* Badge */}
          <div className="mb-4 mt-6 inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-full bg-[#22C55E]/10 text-[#22C55E] font-semibold text-sm border border-[#22C55E]/30 shadow-sm">
            ...
            Trusted by Indian E-commerce Sellers
          </div>

          <div className="grid lg:grid-cols-2 gap-x-12 gap-y-12 items-center text-left w-full mt-2">
            <motion.div
